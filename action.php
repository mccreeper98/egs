            ...
            $mensaje ='<!DOCTYPE html>
                        ...
                        <body style="background-color: #000;">
                            ...
                            background-size: cover; background-repeat: no-repeat;">
                                ...
                                padding-left: 4rem;
                                padding-right: 4rem;">
                                    ¡Bienvenido! Agradecemos tu interés en cubrir la edición 2022 de Entertainment Gaming <br> Show. Por medio de este correo electrónico te informamos que tu aplicación fue <br> APROBADA. El medio de comunicación al que perteneces y tus nombres registrados <br> (máximo 3) estarán en la lista de accesos autorizados.
                                    <br><br>
                                    Te sugerimos que estés al pendiente de tu correo electrónico donde recibirás <br> información adicional del evento y elementos gráficos para apoyar tu cobertura.
                                    <br><br>
                            ...
                            <div style="display: flex; flex-direction: row; justify-content: center;">
                                ...
                                margin-left: 2rem;
                            margin-top: 6px;">
                                    Electronic Game Show ®2022 · Aviso de Privacidad · Términos y Condiciones · Powered by Banana Geek
                                </p>
                            </div>
